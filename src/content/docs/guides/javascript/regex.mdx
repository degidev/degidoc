...
# Expresiones Regulares <Badge variant="success">Fundamental</Badge>

<Aside type="tip">
  Las expresiones regulares son patrones utilizados para hacer coincidir combinaciones de caracteres en cadenas.
</Aside>

## Creación de RegExp <Badge variant="note">Básico</Badge>
...
## Metacaracteres <Badge variant="caution">Importante</Badge>
...
## Métodos de RegExp <Badge variant="caution">Importante</Badge>
...
## Grupos y referencias <Badge variant="caution">Avanzado</Badge>
...
## Patrones comunes <Badge variant="note">Referencia</Badge>
...
## Mejores prácticas <Badge variant="success">Recomendado</Badge>
